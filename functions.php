...
add_action('after_setup_theme', 'after_setup_load', 0);
/**
 * Set the content width in pixels, based on the theme's design and stylesheet.
 * Priority 0 to make it available to lower priority callbacks.
 * @global int $content_width
 */
function after_setup_load() {
...
add_action('wp_enqueue_scripts', 'init_script_load');
/**
 * Enqueue scripts and styles.
 */
function init_script_load() {
...
add_action('enqueue_block_editor_assets', 'block_editor_assets_load');
function block_editor_assets_load() {
    wp_enqueue_style('klarity-style', get_template_directory_uri() . '/editor.css', [], time());
}

add_action('pre_get_posts', 'remove_add_to_any_post');
// Remove AddToAny : we add it ourselves later
function remove_add_to_any_post() {
