	...
	function klarity_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			if ( $categories_list ) {
				...
				printf( '<span class="cat-links">' . esc_html__( ' in %1$s', 'klarity' ) . '</span>', esc_html($categories_list)); // WPCS: XSS OK.
			}
			...
			if ( $tags_list ) {
				...
				printf( '<span class="tags-links">' . esc_html__( 'Tagged %1$s', 'klarity' ) . '</span>', esc_html($tags_list )); // WPCS: XSS OK.
			}
		}
